                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-info">
                                    <a  href="javascript:$('#mainId').load('${path}/test/echarts.jsp')">用户统计</a></button><br><br>
                                <button class="btn btn-info">
                                    <a  href="javascript:$('#mainId').load('${path}/test/userChina.jsp')">用户分布</a></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body">
                                <button class="btn btn-danger">
                                    <a  href="javascript:$('#mainId').load('${path}/admin/admin.jsp')">
                                        管理员信息
                                    </a>
                                </button>
                            </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                            <div class="panel-body">
                                <a  href="javascript:$('#mainId').load('${path}/log/log.jsp')">
