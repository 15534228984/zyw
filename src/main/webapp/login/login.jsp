    ...
    <script>
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/admin/ImageAction?d="+new Date().getTime());
            });
            //表单验证 设置验证码
            $.extend($.validator().messages,{
                required:"必填字段",
                min:$.validator.format("请输入等于4的数值")
            })
        });
    </script>
</head>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="width: 105px" style="height: 130px" class="captchaImage" src="${path}/admin/ImageAction">
                                <input minlength="4" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="vcode" id="form-code">
                            </div>
